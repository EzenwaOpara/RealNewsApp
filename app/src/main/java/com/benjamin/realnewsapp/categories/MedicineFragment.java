...
public class MedicineFragment extends Fragment {
    ...
    private static String TOPIC = "medicine";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_medicine, container, false);
        final ListView listView = view.findViewById(R.id.medicine_list);
